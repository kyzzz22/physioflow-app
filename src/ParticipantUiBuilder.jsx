...
function UiPropertyEditor({ element, onUpdate }) {
  ...
  if (element.type === 'Screen') return <div className="ui-property-grid">
    <label><input type="checkbox" checked={Boolean(props.free)} onChange={event => onUpdate({ free: event.target.checked })} /> Free layout (drag anywhere)</label>
