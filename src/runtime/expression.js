...
export function evaluateExpression(expression, actualValue, expectedOverride) {
  ...
  const expected = expectedOverride !== undefined ? expectedOverride : expression?.expected;
